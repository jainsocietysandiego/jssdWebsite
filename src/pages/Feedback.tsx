...
const Feedback: React.FC = () => {
  ...
  const testimonials = [
    {
      name: 'Priya Patel',
      text: 'JSSD has been a spiritual home for our family. The Pathshala program has given our children a strong foundation in Jain values.',
      rating: 5,
      category: 'Pathshala Education'
    },
    {
      name: 'Rajesh Shah',
